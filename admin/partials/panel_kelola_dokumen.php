...
?>
        <div id="panel-kelola-dokumen" class="card border-0 shadow-sm dash-section">
            <div class="card-body p-4">
                ...
                <p class="text-muted small mb-3">Filter, buka, atau hapus file perpustakaan digital. Pratinjau publik: <a href="../dokumen.php" target="_blank" rel="noopener">halaman dokumen</a>.</p>
