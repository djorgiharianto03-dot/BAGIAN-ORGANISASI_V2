...
if ($orgHeaderBerandaPage) {
    ...
    <link href="https://fonts.googleapis.com/css2?family=Plus+Jakarta+Sans:wght@300;400;500;600;700;800&family=Inter:wght@400;500;600;700;800&family=Roboto:ital,wght@0,400;0,500;0,700;1,400&display=swap" rel="stylesheet">
...
<?php
    ...
    echo org_typography_stylesheet_link();
    ...
    if (str_contains($bodyClassAttr, 'sg-portal-page')) {
        echo '<link rel="stylesheet" href="' . htmlspecialchars(org_asset_url('assets/css/smart-governance-portal-layout-fix.css?v=24'), ENT_QUOTES, 'UTF-8') . '">' . "\n";
    }
}
