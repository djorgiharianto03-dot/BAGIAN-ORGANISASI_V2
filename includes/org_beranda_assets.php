...
function org_beranda_header_vendor_markup(): string
{
    ...
    $out .= '<style id="sg-beranda-head-critical">'
        ...
        . 'body.sg-homepage.sg-portal-page .site-header--sg-portal .navbar-panel,body.sg-homepage.sg-portal-page .site-header--sg-portal .site-header__nav-wrap.navbar-panel{min-height:88px!important;border-radius:20px!important;background:rgba(2,22,48,.94)!important;border:1px solid rgba(147,197,253,.18)!important;box-shadow:inset 0 1px 0 rgba(255,255,255,.07),0 10px 32px rgba(0,10,28,.42)!important;display:flex!important;backdrop-filter:none!important;-webkit-backdrop-filter:none!important}'
