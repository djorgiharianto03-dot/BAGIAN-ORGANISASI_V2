...
function org_container_global_stylesheet_link(bool $includeBerandaRail = true): string
{
    ...
    $markup = '<link rel="stylesheet" href="' . htmlspecialchars(org_asset_url('assets/css/org-container-global.css?v=45'), ENT_QUOTES, 'UTF-8') . '">' . "\n"
    ...
    if ($includeBerandaRail) {
        $markup .= '<link rel="stylesheet" href="' . htmlspecialchars(org_asset_url('assets/css/beranda-portal-rail.css?v=4'), ENT_QUOTES, 'UTF-8') . '">' . "\n";
    }
